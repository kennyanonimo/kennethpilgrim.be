...
<main id="legalMain" class="container">
   <div class="row">
        <div class="col-xs-12">
            ...
            <h3>The following terms constitute our “Acceptable Use Policy”:</h3>
            <p>
            ...
            <p>
                Please read this Arbitration Agreement carefully.  It is part of your contract with Kenneth Pilgrim and affects your rights.  It contains procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.
            </p>
            ...
            <p>
                Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Varkensstraat, 2800, Mechelen. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
            </p>
            ...
            <p>
            Copyright © Kenneth Pilgrim 2017.  All rights reserved.  All trademarks, logos and service marks displayed on the Site are our property or the property of other third-parties . You are not permitted to use these Marks without our prior written consent or the consent of such third parties which may own the Marks.
            </p>

            <h2>Contact Information</h2>
            <p>Telephone: <a href="tel:+32 15 60 60 69">+32 15 60 60 69</a></p>
            <p>Email: <a href="mailto:support@root.land">support@root.land</a></p>

            <h2>Cookies and Web Beacons</h2>
            <p>
                Like any other website, kennethpilgrim.eu uses ‘cookies’.  These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor has accessed or visited.  This information is used to optimize the users’ experience by customizing our web page content based on the visitors’ browser type and/or other information.
            </p>

            <h2>Our Advertising Partners</h2>
            <p>
                Some of advertisers on our site may use cookies and web beacons.<br/>
